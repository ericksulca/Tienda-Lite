...
class Lote(models.Model):
    ...
    proveedor  = models.CharField(max_length=45, blank=True, null=True)  # Field name made lowercase.
...
class Venta(models.Model):
    ...
    productos      = models.ManyToManyField(Producto)
    aperturacaja   = models.ForeignKey(Aperturacaja, blank=True, null=True, on_delete=models.CASCADE)  # Field name made lowercase.
    anulacionventa = models.ForeignKey(Anulacionventa, blank=True, null=True, default = '', on_delete=models.CASCADE)
    estado         = models.BooleanField(blank=True,default=True)
